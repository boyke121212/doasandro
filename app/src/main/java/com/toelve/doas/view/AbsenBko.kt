...
class AbsenBko : Boyke() {

    private lateinit var binding: ActivityAbsenBkoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAbsenBkoBinding.inflate(layoutInflater)
        ...
        onBackPressedDispatcher.addCallback(this) {
            startActivity(Intent(this@AbsenBko, Home::class.java))
            finishAffinity()
        }
    }
