...
import com.toelve.doas.databinding.ActivityAbsenBkoBinding
import com.toelve.doas.databinding.ActivityAbsenDikBinding
...
class AbsenDik : Boyke() {

    private lateinit var binding: ActivityAbsenDikBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAbsenDikBinding.inflate(layoutInflater)
        ...
        onBackPressedDispatcher.addCallback(this) {
            startActivity(Intent(this@AbsenDik, Home::class.java))
            finishAffinity()
        }
    }
